...
<!-- Main -->
<body>
  <div class="div mx-auto" style="width:70%;">
  <table class="table table-inverse" style="margin-top:3%;">
    ...
    <?php foreach($tiket->result() as $row) {?>
      <tr>
  	  ...
  	  <td>
        <a href="<?php echo base_url('index.php/Pusat/appembeliandetail?terminal='. $row->terminal_asal.'&kota='.$row->kota_asal); ?>" class="btn btn-sm btn-warning">Detail Pembelian</a>
  	  </td>
      </tr>
    <?php }?>
