...
<div class="w3-main">
	...
	<div class="about-bottom">
		<div class="w3l_about_bottom_right two">
			<div id="admin">
				<h2 class="tittle"><span>EDIT JADWAL BUS</span></h2>
				<div class="book-form">

				    <form action="<?php echo base_url('index.php/Cabang/acbusupdatejadwal/'. $jadwal->id); ?>" method="post">
							<input type="text" name="terminal_tujuan" value="<?php echo $jadwal->terminal_tujuan;?>">

							<div class="clear"> </div>

              <input type="text" name="kota_tujuan"  value="<?php echo $jadwal->kota_tujuan;?>">

							<div class="clear"> </div>

              <input type="time" name="jam" value="<?php echo $jadwal->jam;?>">

              <div class="clear"> </div>

							<input type="text" name="harga" value="<?php echo $jadwal->harga;?>">
